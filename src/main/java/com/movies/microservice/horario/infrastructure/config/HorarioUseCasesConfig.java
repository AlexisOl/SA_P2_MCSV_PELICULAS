...
public class HorarioUseCasesConfig {
  @Bean 
  public CrearHorarioInputPort crearHorarioUC(HorarioRepositorioOutputPort repo, ValidacionesExternaOutputPort val) {
    return new CrearHorarioUseCase(repo, val);
  }
  @Bean 
